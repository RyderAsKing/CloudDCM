...
namespace App\Policies\Vps_Manager;
...
class VpsPolicy
{
    ...
    public function show(User $user, VPS $vps)
    {
        ...
        return $user->id === $vps->user_id || $user->owner_id === $vps->user_id;
    }
    ...
    public function update(User $user, VPS $vps)
    {
        ...
        return $user->id === $vps->user_id ||
            ($user->owner_id === $vps->user_id &&
                $user->hasPermissionTo('update'));
    }

    public function delete(User $user, VPS $vps)
    {
