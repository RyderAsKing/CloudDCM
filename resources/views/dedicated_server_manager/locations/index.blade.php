<x-app-layout>
    ...
    <div>
        <div class=" mx-auto ">
            ...
            <x-primary-link class="mb-2" href="{{route('dedicated_server_manager.locations.create')}}" type="button">
                Add Location +
            </x-primary-link>
            <x-primary-link class="mb-2" href="{{route('dedicated_server_manager.servers.create')}}" type="button">
                Add server +
            </x-primary-link>

            <div class="flex flex-col">
                <div class="backdrop-blur-sm bg-white p-6 rounded-md shadow-sm  border-2 border-gray-50 ">
                    <h2 class="text-xl font-semibold mb-4">Welcome to Dedicated Server Manager</h2>
                    <p class="text-gray-700">Here you can manage locations/groups and their servers</p>
                ...
                <div class="mt-2 grid grid-cols-3 gap-2">
                    ...
                    <a href="{{route('dedicated_server_manager.servers.index')}}"
                        ...
                        <h2 class="text-lg font-semibold mb-1">Uncategorized <p class="text-green-700 text-sm">
                                {{$locations['uncategorized']}} servers added
                            </p>
                        </h2>
                        <p class="text-gray-700">
                            Server's that are not assigned to any location/group
                        </p>
                    </a>
                    @endif
                </div>
