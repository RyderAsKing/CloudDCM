                    ...
                    <div x-show="modalOpen"
                        ...
                        <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen"
                            ...
                            <div class="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-2">
                                ...
                                <form action="{{route('dedicated_server_manager.locations.destroy', $location->id)}}"
                                    method="post">
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit"
    ...
    <div>
        <div class=" mx-auto ">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <form action="{{ route('dedicated_server_manager.locations.update', $location) }}" method="POST"
